...
// Change the h1 content "DOM Is Awesome"  to have breaks
// and match the example html
let h1Arr = h1_.innerText.split(" ");
h1_.innerHTML = h1Arr.join("</BR>");
...
// Updated address to have a break after street to match the example file
